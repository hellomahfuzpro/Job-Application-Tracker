...
Answer: Event bubbling is a series of event which starts from the target element and then goes by parent event, grandparent event, great grand parent event and so on.
...
Answer: preventDefault stops browser default event where stopPropagation stops the event from going further preenting bubbling.
